...
(function () {
  ...
  style.textContent =
    ...
    '.lw-orb img{width:100%;display:block;border-radius:14px;border:1px solid #20303f;pointer-events:none;-webkit-user-drag:none;user-drag:none;' +
  ...
  orb.innerHTML =
    '<div class="floaty"><img draggable="false" src="assets/img/globe-north-star.webp" alt="Your world and your North Star, lighting up as you progress"></div>' +
  ...
  // ---- draggable (document-level tracking — works anywhere the cursor goes; no native image-drag) ----
  var ox = 0, oy = 0;
  function onMove(e) {
